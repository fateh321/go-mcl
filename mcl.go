...
func G1MulVec(out *G1, xVec []G1, yVec []Fr) {
	...
	C.mclBnG1_mulVecMT(out.getPointer(), (*C.mclBnG1)(unsafe.Pointer(&xVec[0])), (*C.mclBnFr)(unsafe.Pointer(&yVec[0])), (C.size_t)(len(xVec)),64)
}
...
func G2MulVec(out *G2, xVec []G2, yVec []Fr) {
	...
	C.mclBnG2_mulVecMT(out.getPointer(), (*C.mclBnG2)(unsafe.Pointer(&xVec[0])), (*C.mclBnFr)(unsafe.Pointer(&yVec[0])), (C.size_t)(len(xVec)),64)
}
